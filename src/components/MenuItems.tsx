...
const MenuItems = ({ id, name, description, price, image, category, addToCart }: MenuItemsProps) => {
  ...
  return (
    <Card className="flex flex-col w-full h-full items-center p-4 overflow-auto hover:bg-orange-200 transition-colors duration-300">
      ...
      <CardContent className="grid grid-cols-1 gap-1 p-0 pt-1 text-center overflow-auto">
        ...
        <p className="mt-2 text-xs sm:text-sm text-center items-center font-semibold justify-center text-gray-700">{description}</p>
